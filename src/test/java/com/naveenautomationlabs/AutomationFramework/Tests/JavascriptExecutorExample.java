...
public class JavascriptExecutorExample {
	...
	public void sendKeysUsingJavaScriptExecutor() {
		jse.executeScript("arguments[0].value='manpreetkaur1991@gmail.com';", wd.findElement(By.id("input-email")));
	}

	@Test
	public void clickUsingJavaScriptExecutor() {
		jse.executeScript("arguments[0].value='manpreetkaur1991@gmail.com';", wd.findElement(By.id("input-email")));
		jse.executeScript("arguments[0].value='manpreetkaur';", wd.findElement(By.id("input-password")));
